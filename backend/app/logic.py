...
def calcular_nfass_ofass(sintomas_ids):
    ...
    DB_SINTOMAS = {
        ...
        'rash_few':    {'sys': 'Skin',    'lambda': 0.05, 'epsilon': 0},
        'rash_less_50':  {'sys': 'Skin',    'lambda': 0.07, 'epsilon': 0},
        'rash_3_10':  {'sys': 'Skin',    'lambda': 0.08, 'epsilon': 0},
        'urticaria_more_10':    {'sys': 'Skin',    'lambda': 0.08, 'epsilon': 0},
        'urticaria_gen':    {'sys': 'Skin',    'lambda': 0.08, 'epsilon': 0},
        'urticaria_gen':    {'sys': 'Skin',    'lambda': 0.08, 'epsilon': 0},
