...
import { generarReportePDF } from './utils/pdfGenerator'; // Importación de la lógica externa
      ...
      <div style={{ padding: '20px', maxWidth: '1300px', margin: '0 auto' }}>
        ...
        {view === 'historial_global' && (
          <HistorialView
            ...
            generarReportePDF={(p) => generarReportePDF(p, usuarioLogueado)} // Llamada a función externa
