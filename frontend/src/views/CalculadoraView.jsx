      ...
      <div style={styles.cardStyle}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
             ...
             {esPacienteExistente && (
               <span style={{ fontSize: '10px', color: '#2563eb', fontWeight: 'bold', marginTop: '4px' }}>
                 PACIENTE REGISTRADO
               </span>
             )}
          </div>
        ...
        <button onClick={enviarEvaluacion} style={styles.calcBtn}>
          {resultado ? 'Recalcular Gravedad nFASS' : 'Calcular Gravedad nFASS'}
        </button>
      </div>
    </section>
